                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-sm-6 col-lg-6 text-center text-md-right ">
                                        @if (auth('asesor')->check())
                                            <a href="{{ route('asesor-jadwal.create') }}"
                                                class="btn btn-success btn-sm m-1"> <i class="fa fa-plus"></i>
                                                Tambah
                                                Data</a>
                                        @else
                                            <a href="{{ route('jadwal.create') }}" class="btn btn-success btn-sm m-1"> <i
                                                    class="fa fa-plus"></i>
                                                Tambah
                                                Data</a>
                                        @endif
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        @if (auth('asesor')->check())
                                                            <a href="{{ route('asesor-jadwal.edit', $item->id) }}"
                                                                class="m-1 btn btn-sm btn-secondary"
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                title="Edit data"><i class="fa fa-edit"></i></a>

                                                            @if ($item->enabled == 1)
                                                                <a href="{{ route('asesor-jadwal.setActive', $item->id) }}"
                                                        ...
                                                        @else
                                                            ...
                                                            @if ($item->enabled == 1)
                                                                <a href="{{ route('jadwal.setActive', $item->id) }}"
                                                                    class="m-1 ml-2 btn btn-sm btn-danger"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Non aktifkan"><i class="fa fa-times"></i></a>
                                                            @else
